    ...
    React.useEffect(() => {
        const auth_user_data = async () => {
            ...
            AsyncStorage.getItem('auth_user', (err, result) => {
                ...
                console.log("parsedData in AppBar", auth_user);
            });
        ...
        <>
            ...
            <View style={styles.userCard}>
                ...
                <View style={styles.userInfo}>
                    ...
                    <Text style={styles.userName}>{auth_user?.name ? auth_user?.name : "Anonymous"}</Text>
