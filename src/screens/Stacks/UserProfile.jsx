        ...
        <View style={styles.container}>
          ...
          <View style={styles.header}>
            ...
            <View style={styles.info}>
              ...
              <Text style={styles.user_city_text}>chandigarh</Text>
