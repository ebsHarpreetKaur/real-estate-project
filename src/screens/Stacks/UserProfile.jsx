      ...
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.info}>
            ...
            <Button style={{ backgroundColor: theme_color }} title="Edit Profile" onPress={() => { }} />
          </View>
        </View>
        ...
        {/* <MaterialCommunityIcons style={{marginTop:"70%", marginLeft:"45%"}} name="video" color={theme_color} size={50} onPress={handleVideoConferencing} /> */}
