...
import { View, Image, Text, Button, SafeAreaView, StyleSheet } from 'react-native';
        ...
        <View style={styles.container}>
          ...
          <View style={styles.header}>
            ...
            <View style={styles.info}>
              ...
              <Button style={{ backgroundColor: "#0066b2" }} title="Edit Profile" onPress={() => { }} />
            </View>
          </View>
